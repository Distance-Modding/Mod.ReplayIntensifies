...
namespace Distance.ReplayIntensifies.Patches
{
	...
	internal static class PlayerDataBase__Initialize
	{
		...
		internal static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
		{
			...
			Mod.Log.LogInfo("Transpiling... (1/3)");
			// VISUAL:
			...
			for (int i = 0; i < codes.Count; i++)
			{
				...
				{
					Mod.Log.LogInfo($"callvirt get_ClampCarColors_ @ {i}");
			...
			Mod.Log.LogInfo("Transpiling... (2/3)");
			// VISUAL:
			...
			for (int i = 0; i < codes.Count; i++)
			{
				...
				{
					Mod.Log.LogInfo($"call UseCarWithName @ {i}");
			...
			Mod.Log.LogInfo("Transpiling... (3/3)");
			// VISUAL:
			...
			for (int i = 0; i < codes.Count; i++)
			{
				...
				{
					Mod.Log.LogInfo($"call SetOriginalColors @ {i}");
